...
async function startMetro(expoPublicDomain, expoPublicReplId, clerkPublishableKey, clerkProxyUrl) {
...
async function main() {
  ...
  const clerkProxyUrl = process.env.CLERK_PROXY_URL ? `https://${domain}${process.env.CLERK_PROXY_URL}` : '';
  await startMetro(domain, expoPublicReplId, process.env.CLERK_PUBLISHABLE_KEY, clerkProxyUrl);
